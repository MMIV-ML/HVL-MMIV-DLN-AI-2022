...
- [**0-test-installation.ipynb**](https://nbviewer.jupyter.org/github/HVL-MMIV-DLN-AI_2022/blob/main/2-biomedical_imaging/0-test-installation.ipynb) (relevant only for local installation, cf. `environment-img.yml` and `setup-img.md`)
